...
public class Hj {
	...
	public static void login(){
		try{
		  ...
		  MyHttpResponse res = (MyHttpResponse)getConfig(dir+"hjLogin",null); 
		  if (res==null){
			  res= HttpClientUtil.httpGet(loginUrl+req, null, "UTF-8");
			  saveDate(dir+"hjLogin",res);
		  }
		 // System.out.println(res.getBody());
	...
	public static String getToken(){
		...
		MyHttpResponse token = (MyHttpResponse)getConfig(dir+"hjToken",null);
		if (token==null){
		   token= HttpClientUtil.httpPostRaw(tokenUrl,stringJson, headers, "UTF-8");
		   saveDate(dir+"hjToken",token);
		}
	...
	public static String getBook(){
		...
		String sd = "2018-09-05T09:40:00.000";
		//sd = DateUtil.getPreTime(sd);
		oj.put("finishedDate",sd);
		oj = (JSONObject)getConfig(dir+"hjConfig",oj);
	...
	private static Object getConfig(String fn, Object config){
		Object ret=  config;
		try{
	...
	private static void saveDate(String fn, Object config){
		try{
